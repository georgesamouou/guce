...
public class SignatorySearchFimexRequestsApplicationService implements SignatorySearchFimexRequestsUseCase {

    private final FimexRequestQueryService queryService;

    @Override
    public Page<FimexRequestSummary> execute(SearchCriteria criteria) {
        return queryService.searchForSignatory(criteria);
    }
}