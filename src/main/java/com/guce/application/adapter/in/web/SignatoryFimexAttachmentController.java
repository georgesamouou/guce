...
@RestController
@RequestMapping("/api/v1/fimex/signatory/requests/{requestId}/attachments")
@RequiredArgsConstructor
@Tag(name = "FIMEX Signatory - Pièces Jointes", description = "Consultation des PJs pour signataires")
@PreAuthorize("hasRole('FIMEX_SIGNATORY')")
public class SignatoryFimexAttachmentController {
